...
const { data } = await createPayment({ amount: ..., currency: ..., status: ..., paymentMethod: ..., stripePaymentIntentId: ..., paypalOrderId: ..., mpesaReceiptNumber: ..., });
...
// Variables can be defined inline as well.
const ref = createPaymentRef({ amount: ..., currency: ..., status: ..., paymentMethod: ..., stripePaymentIntentId: ..., paypalOrderId: ..., mpesaReceiptNumber: ..., });
